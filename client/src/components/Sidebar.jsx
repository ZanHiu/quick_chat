    ...
    ${selectedUser ? 'max-md:hidden' : ''}`}>
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
          <img alt='Logo' src={assets.logo} className='max-w-40' />
          <div className='relative py-2 group'>
            <img alt='Menu' src={assets.menu_icon} className='max-h-5 cursor-pointer' />
      ...
      <div className='flex flex-col'>
        {filteredUsers.map((user, index) => (
          ...
          >
            <img alt='' src={user?.profilePic || assets.avatar_icon} className='w-[35px] aspect-[1/1] rounded-full' />
