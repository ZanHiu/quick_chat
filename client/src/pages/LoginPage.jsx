...
const LoginPage = () => {
  ...
  return (
    ...
    sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      {/* ----- right ----- */}
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        <h2 className='font-medium text-2xl flex justify-between items-center'>
          {currState}
          {isDataSubmitted && (
            <img onClick={() => setIsDataSubmitted(false)} alt='' src={assets.arrow_icon} className='w-5 cursor-pointer' />
          )}
        </h2>
